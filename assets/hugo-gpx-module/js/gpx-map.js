      ...
      createRouteSelector() {
        ...
        sortedIds.forEach(id => {
          ...
          div.innerHTML = `
            ...
            <button onclick="window.gpxMaps['${this.mapId}'].downloadGPX(${id})" title="Download GPX" style="background:transparent;color:#007bff;border:1px solid #cce5ff;border-radius:4px;padding:2px 6px;cursor:pointer;font-size:1.1rem;">📥</button>
          `;
